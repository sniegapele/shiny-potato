public class ParalleledAlgorithmBarrier {
    ...
    public ParalleledAlgorithmBarrier(int numberOfThreads, long upperBound) {
...
//        double time = (System.currentTimeMillis() - startTime) / 1000.;
        ...
        System.out.println("--------------------------------------");
        System.out.println("Paralleled algorithm - barrier method");
