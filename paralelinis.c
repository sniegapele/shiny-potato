...
//    bool *myInterval = malloc(numberOfNumberInInterval * sizeof(bool));
...
//
//void generatePrimeNumbers(long *numberOfNumbers, long upperBound, long *primes) {
//    long sqrtFromUpperBound = (long) sqrt(upperBound);
//
//    // init array
//    bool *interval = malloc((sqrtFromUpperBound - 1) * sizeof(bool));
//    for (long i = 0; i < sqrtFromUpperBound - 1; i++) {
//        interval[i] = true;
//    }
//
//    // calculate primes until sqrt(upperBound) reached
//    long sqrtOfSqrt = (long) sqrt(sqrtFromUpperBound);
